...
namespace AppBuenaAventura.Controllers
{
    public class HotelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Ubicacion,Descripcion,Reseña,AgenciaId,AgenteId")] Hotel hotel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Ubicacion,Descripcion,Reseña,AgenciaId,AgenteId")] Hotel hotel)
        {
            if (id != hotel.Id)
            {
                return NotFound();
